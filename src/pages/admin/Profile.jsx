...
export default function Profile() {
  ...
  React.useEffect(() => {
    // Load profile data - for admin, we'll use identifier as email
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      // For admin, profile management would need to be implemented differently
      // as admin uses a separate Admin table
      // For now, we'll show a message
      toast.success('Profile updated successfully (Admin profile management coming soon)');
      setIsEditing(false);
      setProfilePic(null);
    } catch (error) {
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex flex-col items-center md:items-start">
                <div className="relative">
                  <div className="h-32 w-32 overflow-hidden rounded-full bg-gradient-to-br from-green-400 to-blue-500 ring-4 ring-white shadow-lg">
                    {profilePicPreview ? (
                      <img
                  ...
                  {isEditing && (
                    <button
                      ...
                      className="absolute bottom-0 right-0 rounded-full bg-green-600 p-2 text-white shadow-md transition hover:bg-green-700"
                    >
              ...
              <div className="flex-1">
                <div className="mb-4">
                  <h3 className="text-xl font-semibold text-gray-900">{profile.fullName || 'Admin'}</h3>
                ...
                {isEditing ? (
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      <div className="text-xs font-semibold uppercase tracking-wide text-gray-500">College Name</div>
