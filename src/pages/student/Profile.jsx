...
export default function Profile() {
  ...
  const loadProfile = async () => {
    try {
      ...
      if (data) {
        setProfile({
          fullName: data.fullName || user?.name || user?.identifier || '',
      ...
      setProfile({
        fullName: user?.name || user?.identifier || '',
            ...
            <div className="flex flex-col gap-6 md:flex-row">
              ...
              <div className="flex flex-col items-center md:items-start">
                <div className="relative">
                  <div className="h-32 w-32 overflow-hidden rounded-full bg-gradient-to-br from-blue-400 to-purple-500 ring-4 ring-white shadow-lg">
                    {profilePicPreview ? (
                      <img
                      ...
                      <div className="flex h-full w-full items-center justify-center text-4xl font-bold text-white">
                        {profile.fullName?.charAt(0)?.toUpperCase() || user?.identifier?.charAt(0)?.toUpperCase() || 'U'}
                      </div>
                    )}
                  </div>
                  {isEditing && (
              ...
              <div className="flex-1">
                <div className="mb-4">
                  <h3 className="text-xl font-semibold text-gray-900">{profile.fullName || user?.identifier || 'User'}</h3>
                ...
                {isEditing ? (
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                      <div className="text-xs font-semibold uppercase tracking-wide text-gray-500">Roll No</div>
                      <div className="mt-1 text-sm text-gray-900">{user?.identifier || '—'}</div>
                    </div>
                    <div>
