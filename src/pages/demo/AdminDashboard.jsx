    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100">
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-green-700">Upload and manage academic certificates</p>
        </div>

        {/* Upload Form */}
        <Card className="mb-8 bg-white shadow-lg rounded-xl border-2 border-green-200">
          ...
          <form onSubmit={handleSubmit} className="grid gap-4 md:grid-cols-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, certificateTitle: e.target.value }))
              }
            />
            ...
            <div className="md:col-span-2">
              <Button
                type="submit"
                variant="primary"
                className="w-full md:w-auto bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-semibold"
              >
                Upload Certificate
              </Button>
            </div>
        ...
        {uploadedCert && (
          <Card className="mb-8 bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 shadow-lg rounded-xl">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Format: CERT-&lt;STUDENTID&gt;-&lt;RANDOM4DIGIT&gt;
                  </p>
                </div>
        ...
        {/* Certificates Table */}
        <Card className="bg-white shadow-lg rounded-xl border-2 border-green-200">
          <h2 className="text-2xl font-semibold text-green-800 mb-6">
